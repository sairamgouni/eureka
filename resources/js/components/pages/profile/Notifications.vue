...
<!--							<img src="assets/img/avatar1-sm.jpg" alt="author">-->
						...
						<div class="notification-event">
							<a href="#" class="h6 notification-friend">{{notification.notifier_name}}</a> {{notification.message}} <a
...
<!--												<svg class="olymp-comments-post-icon"><use-->
                        ...
                        <!--						<div class="more">-->
                        <!--							<svg class="olymp-three-dots-icon"><use-->
                        <!--                                xlink:href="assets/svg-icons/sprites/icons.svg#olymp-three-dots-icon"></use></svg>-->
                        <!--							<svg class="olymp-little-delete"><use-->
                        <!--                                xlink:href="assets/svg-icons/sprites/icons.svg#olymp-little-delete"></use></svg>-->
                        <!--						</div>-->
					</li>
                    ...
                    <!--						</div>-->
                    <!--						<div class="notification-event">-->
                    <!--							You and <a href="#" class="h6 notification-friend">Nicholas Grissom</a> just became friends. Write on <a-->
                    <!--                            href="#" class="notification-link">his wall</a>.-->
                    ...
                    <!--						</div>-->
                    <!--						<div class="notification-event">-->
                    <!--							<a href="#" class="h6 notification-friend">Sarah Hetfield</a> commented on your <a href="#"-->
                    ...
                    <!--						</div>-->
                    <!--						<div class="notification-event">-->
                    <!--							<a href="#" class="h6 notification-friend">Green Goo Rock</a> invited you to attend to his event Goo in <a-->
