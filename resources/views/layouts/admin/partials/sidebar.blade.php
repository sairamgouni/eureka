            ...
            <ul class="left-menu">
                ...
                <li>
                    <a href="{{url('admin/users')}}">
                        <svg class="olymp-star-icon left-menu-icon"  data-toggle="tooltip" data-placement="right"   data-original-title="Users"><use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-happy-faces-icon"></use></svg>
                    </a>
                </li>
                <li>
                    <a href="{{url('admin/challenges')}}">
                        <svg class="olymp-newsfeed-icon left-menu-icon" data-toggle="tooltip" data-placement="right"   data-original-title="Challenges">
                            <use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-calendar-icon"></use>
                        </svg>
                    </a>
                </li>
                <li>
