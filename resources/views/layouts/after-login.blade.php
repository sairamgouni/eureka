...
<div class="fixed-sidebar">
	<div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
		...
		<a href="02-ProfilePage.html" class="logo">
			<div class="img-wrap">
				<img src="{{asset('assets/img/eureka/eureka-logo.png')}}" alt="Eureka">
			</div>
		</a>
	...
	<div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1">
		...
		<div class="mCustomScrollbar" data-mcs-theme="dark">
			<ul class="left-menu">
				<li>
					<a href="#" class="js-sidebar-open">
						<svg class="olymp-close-icon left-menu-icon"><use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-close-icon"></use></svg>
	...
	<div class="fixed-sidebar-right sidebar--large" id="sidebar-right-1">
			...
			<ul class="chat-users">
				<li class="inline-items js-chat-open">
					...
					<div class="more"><svg class="olymp-three-dots-icon"><use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-three-dots-icon"></use></svg>
						...
						<ul class="more-icons">
							<li>
								<svg data-toggle="tooltip" data-placement="top" data-original-title="START CONVERSATION" class="olymp-comments-post-icon"><use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-comments-post-icon"></use></svg>
							</li>

							<li>
								<svg data-toggle="tooltip" data-placement="top" data-original-title="ADD TO CONVERSATION" class="olymp-add-to-conversation-icon"><use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-add-to-conversation-icon"></use></svg>
							</li>

							<li>
								<svg data-toggle="tooltip" data-placement="top" data-original-title="BLOCK FROM CHAT" class="olymp-block-from-chat-icon"><use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-block-from-chat-icon"></use></svg>
							</li>
						</ul>
		...
		<div class="search-friend inline-items">
			...
			<a href="29-YourAccount-AccountSettings.html" class="settings">
				<svg class="olymp-settings-icon"><use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-settings-icon"></use></svg>
			</a>
						...
						<div class="mCustomScrollbar" data-mcs-theme="dark">
							...
							<form class="form-group with-button custom-status">
								...
								<button class="bg-purple">
									<svg class="olymp-check-icon"><use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-check-icon"></use></svg>
								</button>
							</form>
							...
							<div class="post-additional-info inline-items">
								...
								<a href="#" class="post-add-icon inline-items">
									<svg class="olymp-heart-icon">
										<use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-heart-icon"></use>
									</svg>
									<span>8</span>
								</a>
								...
								<div class="comments-shared">
									...
									<a href="#" class="post-add-icon inline-items">
										<svg class="olymp-share-icon">
											<use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-share-icon"></use>
										</svg>
										<span>24</span>
									</a>
								</div>
							...
							<div class="control-block-button post-control-button">
								...
								<a href="#" class="btn btn-control featured-post">
									<svg class="olymp-trophy-icon">
										<use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-trophy-icon"></use>
									</svg>
								</a>
					
								<a href="#" class="btn btn-control">
									<svg class="olymp-like-post-icon">
										<use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-like-post-icon"></use>
									</svg>
								</a>
					
								<a href="#" class="btn btn-control">
									<svg class="olymp-comments-post-icon">
										<use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-comments-post-icon"></use>
									</svg>
								</a>
					...
					<article class="hentry post video">
							...
							<div class="post-video">
								<div class="video-thumb">
									<img src="{{asset('assets/img/video5.jpg')}}" alt="photo">
					...
					<ul class="comments-list">
						...
						<li class="comment-item has-children">
							...
							<ul class="children">
								<li class="comment-item">
									<div class="post__author author vcard inline-items">
										<img src="{{asset('assets/img/avatar8-sm.jpg')}}" alt="author">
						...
						<li class="comment-item">
							<div class="post__author author vcard inline-items">
								<img src="{{asset('assets/img/avatar4-sm.jpg')}}" alt="author">
				...
				<div class="ui-block">
					...
					<article class="hentry post has-post-thumbnail shared-photo">
							...
							<div class="post-thumb">
								<img src="{{asset('assets/img/post-photo6.jpg')}}" alt="photo">
							</div>
							...
							<div class="post-additional-info inline-items">
								...
								<ul class="friends-harmonic">
									<li>
										<a href="#">
											<img src="{{asset('assets/img/friend-harmonic5.jpg')}}" alt="friend">
										</a>
									</li>
									<li>
										<a href="#">
									...
									<li>
										<a href="#">
											<img src="{{asset('assets/img/friend-harmonic2.jpg')}}" alt="friend">
										</a>
									</li>
								</ul>
				...
				<ol class="widget w-playlist">
					<li class="js-open-popup" data-popup-target=".playlist-popup">
						<div class="playlist-thumb">
							<img src="{{asset('assets/img/playlist6.jpg')}}" alt="thumb-composition">
							<div class="overlay"></div>
							<a href="#" class="play-icon">
								<svg class="olymp-music-play-icon-big">
									<use xlink:href="{{asset('assets/svg-icons/sprites/icons-music.svg')}}#olymp-music-play-icon-big"></use>
								</svg>
							</a>
						</div>
					...
					<li class="js-open-popup" data-popup-target=".playlist-popup">
						<div class="playlist-thumb">
							<img src="{{asset('assets/img/playlist7.jpg')}}" alt="thumb-composition">
							<div class="overlay"></div>
							<a href="#" class="play-icon">
								<svg class="olymp-music-play-icon-big">
									<use xlink:href="{{asset('assets/svg-icons/sprites/icons-music.svg')}}#olymp-music-play-icon-big"></use>
					...
					<li class="js-open-popup" data-popup-target=".playlist-popup">
						<div class="playlist-thumb">
							<img src="{{asset('assets/img/playlist8.jpg')}}" alt="thumb-composition">
							<div class="overlay"></div>
							<a href="#" class="play-icon">
								<svg class="olymp-music-play-icon-big">
									<use xlink:href="{{asset('assets/svg-icons/sprites/icons-music.svg')}}#olymp-music-play-icon-big"></use>
					...
					<li class="js-open-popup" data-popup-target=".playlist-popup">
						<div class="playlist-thumb">
							<img src="{{asset('assets/img/playlist9.jpg')}}" alt="thumb-composition">
							<div class="overlay"></div>
							<a href="#" class="play-icon">
								<svg class="olymp-music-play-icon-big">
									<use xlink:href="{{asset('assets/svg-icons/sprites/icons-music.svg')}}#olymp-music-play-icon-big"></use>
				...
				<ul class="widget w-twitter">
					<li class="twitter-item">
						<div class="author-folder">
							<img src="{{asset('assets/img/twitter-avatar1.png')}}" alt="avatar">
							<div class="author">
				...
				<div class="ui-block-content">
					...
					<ul class="widget w-last-video">
						<li>
							...
							<img src="{{asset('assets/img/video8.jpg')}}" alt="video">
							<div class="video-content">
						...
						<li>
							...
							<img src="{{asset('assets/img/video7.jpg')}}" alt="video">
							<div class="video-content">
			...
			<div class="ui-block">
				...
				<div class="ui-block-content">
					...
					<ul class="widget w-last-photo js-zoom-gallery">
						<li>
							<a href="{{asset('assets/img/last-photo10-large.jpg')}}">
								<img src="{{asset('assets/img/last-photo10-large.jpg')}}" alt="photo">
							</a>
						</li>
						<li>
							<a href="{{asset('assets/img/last-phot11-large.jpg')}}">
								<img src="{{asset('assets/img/last-phot11-large.jpg')}}" alt="photo">
							</a>
						</li>
						<li>
							<a href="{{asset('assets/img/last-phot12-large.jpg')}}">
								<img src="{{asset('assets/img/last-phot12-large.jpg')}}" alt="photo">
							</a>
						</li>
						<li>
							<a href="{{asset('assets/img/last-phot13-large.jpg')}}">
								<img src="{{asset('assets/img/last-phot13-large.jpg')}}" alt="photo">
							</a>
						</li>
						<li>
							<a href="{{asset('assets/img/last-phot14-large.jpg')}}">
								<img src="{{asset('assets/img/last-phot14-large.jpg')}}" alt="photo">
							</a>
						</li>
						<li>
							<a href="{{asset('assets/img/last-phot15-large.jpg')}}">
								<img src="{{asset('assets/img/last-phot15-large.jpg')}}" alt="photo">
							</a>
						</li>
						<li>
							<a href="{{asset('assets/img/last-phot16-large.jpg')}}">
								<img src="{{asset('assets/img/last-phot16-large.jpg')}}" alt="photo">
							</a>
						</li>
						<li>
							<a href="{{asset('assets/img/last-phot17-large.jpg')}}">
								<img src="{{asset('assets/img/last-phot17-large.jpg')}}" alt="photo">
							</a>
						</li>
						<li>
							<a href="{{asset('assets/img/last-phot18-large.jpg')}}">
								<img src="{{asset('assets/img/last-phot18-large.jpg')}}" alt="photo">
							</a>
						</li>
					</ul>
				...
				<ul class="widget w-friend-pages-added notification-list friend-requests">
					<li class="inline-items">
						...
						<span class="notification-icon" data-toggle="tooltip" data-placement="top" data-original-title="ADD TO YOUR FAVS">
							<a href="#">
								<svg class="olymp-star-icon"><use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg')}}#olymp-star-icon"></use></svg>
							</a>
						</span>
						...
						<li>
							<div class="skills-item">
								...
								<ul class="friends-harmonic">
									<li>
										<a href="#">
											<img src="{{asset('assets/img/friend-harmonic1.jpg')}}" alt="friend">
										</a>
									</li>
									<li>
										<a href="#">
									...
									<li>
										<a href="#">
											<img src="{{asset('assets/img/friend-harmonic3.jpg')}}" alt="friend">
										</a>
									</li>
									<li>
										<a href="#">
											<img src="{{asset('assets/img/friend-harmonic4.jpg')}}" alt="friend">
										</a>
									</li>
									<li>
										<a href="#">
									...
									<li>
										<a href="#">
											<img src="{{asset('assets/img/friend-harmonic6.jpg')}}" alt="friend">
										</a>
									</li>
									<li>
										<a href="#">
						...
						<li>
							<div class="skills-item">
								...
								<ul class="friends-harmonic">
									...
									<li>
										<a href="#">
											<img src="{{asset('assets/img/friend-harmonic12.jpg')}}" alt="friend">
										</a>
									</li>
									<li>
										<a href="#">
											<img src="{{asset('assets/img/friend-harmonic13.jpg')}}" alt="friend">
										</a>
									</li>
								</ul>
							</div>
						...
						<li>
							<div class="skills-item">
								...
								<ul class="friends-harmonic">
									<li>
										<a href="#">
											<img src="{{asset('assets/img/friend-harmonic14.jpg')}}" alt="friend">
										</a>
									</li>
									<li>
										<a href="#">
											<img src="{{asset('assets/img/friend-harmonic15.jpg')}}" alt="friend">
										</a>
									</li>
								</ul>
							</div>
...
<div class="window-popup playlist-popup" tabindex="-1" role="dialog" aria-labelledby="playlist-popup" aria-hidden="true">
	...
	<div class="mCustomScrollbar">
		...
		<tr>
			<td class="play">
				<a href="#" class="play-icon">
					<svg class="olymp-music-play-icon-big"><use xlink:href="{{asset('assets/svg-icons/sprites/icons-music.svg')}}#olymp-music-play-icon-big"></use></svg>
				</a>
			</td>
			<td class="cover">
				<div class="playlist-thumb">
	...
	<audio id="mediaplayer" data-showplaylist="true">
		<source src="{{asset('assets/mp3/Twice.mp3')}}" title="Track 1" data-poster="track1.png" type="audio/mpeg">
		<source src="{{asset('assets/mp3/Twice.mp3')}}" title="Track 2" data-poster="track2.png" type="audio/mpeg">
		<source src="{{asset('assets/mp3/Twice.mp3')}}" title="Track 3" data-poster="track3.png" type="audio/mpeg">
		<source src="{{asset('assets/mp3/Twice.mp3')}}" title="Track 4" data-poster="track4.png" type="audio/mpeg">
	</audio>
