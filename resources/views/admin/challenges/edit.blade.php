		...
		<div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			...
			<div class="ui-block">
				<div class="ui-block-title bg-blue">
					<h6 class="title c-white">Edit Challenge</h6>
                          ...
                          <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							...
							<div class="form-group">
                             <label class="control-label">Categories</label>
                                {!! Form::select('categories[]', $category, $selectedCategories, ['class' => 'form-control', 'multiple' => 'multiple','id'=>'cat']) !!}
								...
								<div class="form-group">
									...
									<?php
							             ...
							             if($record)
							             {
							              	...
							              	$about_user  = $record->description;
							             }
             						?>
									<textarea class="form-control" style="height: 140px" name="description">{{$about_user}}</textarea>
								</div>
