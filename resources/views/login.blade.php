             ...
             <div class="row login-cont">
              ...
              <div id="loginfrm">
                        ...
                        <p class="userlogin1">
                            ...
                            <input type="text" id="email" type="email" class="input" @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus size="20" placeholder="Username" /></label>
                            @error('email')
                        ...
                        <p class="passwrd1">
                            <label for="user_pass" >
                            <input  id="password" type="password" @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" class="input" value="" size="20" placeholder="Password" /></label> 
                             @error('password')
                        ...
                        <p class="submit1">
                            ...
                            <input type="submit" name="wp-submit" id="real_submit"  class="btn" value="Login" />
                                ...
                                <a href="" class="btn btn-default pull-right">Checking... <img width="25" src="{{asset('assets/login-assets/img/loading.gif')}}" /></a>
                                </span>
                        </p>
                      <p>
                        @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" title="Password Lost and Found"  class="frgt-password" style="cursor:pointer">Forgot password?</a>
                        @endif
                      </p>
                    </form>
                    </div> 
